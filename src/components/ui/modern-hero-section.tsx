      ...
      <>
        ...
        >
          ...
          <div className="container relative z-10 mx-auto px-4 text-center">
            <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight text-foreground" style={{ fontFamily: 'Montserrat, sans-serif', letterSpacing: '-0.03em' }}>
              {title}
            </h1>
            <p className="mx-auto mt-6 max-w-3xl text-lg md:text-xl lg:text-2xl text-muted-foreground" style={{ fontFamily: 'Montserrat, sans-serif' }}>
              {subtitle}
            </p>
          </div>
            ...
            <div className="flex flex-col items-center justify-center gap-8 sm:flex-row sm:gap-16">
              {stats.map((stat, index) => (
                <div key={index} className="text-center">
                  <p className="text-4xl font-bold tracking-tight" style={{ color: '#EA3C23' }}>
                    {stat.value}
                  </p>
                  <p className="mt-1 text-sm font-medium text-muted-foreground uppercase" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                    {stat.label}
                  </p>
                </div>
              ))}
