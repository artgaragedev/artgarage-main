        ...
        <div className="relative">
          {icon && (
            <div className={cn(
              ...
              isFloating ? "top-4 text-[#EA3C23]" : "top-5 text-gray-400"
            )}>
              {icon}
            </div>
          )}
          ...
          <textarea
            ...
            className={cn(
              "peer w-full px-4 pt-7 pb-3 rounded-2xl border-2 transition-all duration-200 bg-white dark:bg-gray-900/50 text-gray-900 dark:text-white placeholder-transparent focus:outline-none focus:border-[#EA3C23] hover:border-gray-400 dark:hover:border-gray-600 resize-none",
              icon ? 'pl-12' : '',
              error
            ...
            <label
              className={cn(
                ...
                isFloating
                  ...
                  : 'top-5 text-base text-gray-500 dark:text-gray-400'
              )}
              style={{
                fontFamily: 'Montserrat, sans-serif'
              }}
